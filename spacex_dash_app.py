...
file = r"d:\Users\steve\OneDrive\Accenture\Personal\2025\IBM-Data-Science-Certificate\10-AppliedDataScienceCapstone\03-InteractiveVisualAnalytics\spacex_launch_dash-2.csv"
...
def get_scatter_plot(entered_site, payload_slider):
   min_value, max_value = payload_slider
   payload_df = spacex_df[(spacex_df['Payload Mass (kg)'] >= min_value) & (spacex_df['Payload Mass (kg)'] <= max_value)]
   if entered_site == 'ALL':
